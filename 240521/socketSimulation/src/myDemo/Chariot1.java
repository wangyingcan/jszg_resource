...
/**
 * @className Chariot1
 * @Description 战车1 服务端之一
 * @Author wangyingcan
 * @DATE 2024/5/23 15:48
 */
public class Chariot1 {
    // 1.服务端默认端口
    private static final int DEFAULT_PORT = Constant.CHARIOT1_PORT;
                ...
                try {
                    while (true) {
                        ...
                        while ((len = inputStream.read(data)) != -1) {
                            ...
                            // 写入日志
                            File file = new File("/Users/wangyingcan/00 工作目录/1 IDC_projects/3 江山重工/3 我的工作/5.21 代码模拟控制中心、网关、战车及其通信/模拟工作/socketSimulation/socketSimulation/src/log/log_chariot1.txt");
                        ...
                        String logData = new String(new Date() + " 战车1" + "执行指令" + "成功\n");
    ...
    public static void main(String[] args) throws Exception {
        Chariot1 chariot1 = new Chariot1(Constant.CHARIOT1_PORT);
